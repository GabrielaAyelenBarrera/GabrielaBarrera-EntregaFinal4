...
- `pages/` → páginas internas (Servicios, Tecnología, Nosotros, Clientes)
- `css/` → estilos (CSS)
- `scss/` → estilos fuente (SASS)
- `js/` → scripts
- `img/` → imágenes
- `audio/` → audios
- `video/` → videos
- `font/` → fuentes (si aplica)
...
`http://127.0.0.1:5500/desarrollo-web-coderhouse-main/index.html`


---

## ✅ Funcionalidades principales
- Navegación entre secciones y páginas internas
